...
بناءً على التحليلات الستة أعلاه، قدم حكمك النهائي حول جدوى الوساطة التجارية في هذا القطاع، مع تحديد النموذج الأمثل."""
        ...
        try:
            ...
            return json.dumps({"summary": content, "consensus": [], "conflicts": [], "verdict": "تحتاج دراسة أعمق", "overall_score": 0, "score_justification": "", "recommended_model": "", "model_justification": "", "advice": [], "weighted_breakdown": {}, "contradictions_found": [], "critical_data_gaps": [], "overall_confidence": 0}, ensure_ascii=False)
