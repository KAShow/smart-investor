...
# ═══════════════════════════════════════════
# APIs لحماية البيانات الحساسة (لا تُكشف في frontend)
# ═══════════════════════════════════════════
...
def api_companies():
    """شركات البحرين - بيانات حساسة تُقدم عبر API فقط."""
    return jsonify(_BAHRAIN_COMPANIES)


@app.route('/api/solutions')
def api_solutions():
    """حلول الوساطة - بيانات حساسة تُقدم عبر API فقط."""
    return jsonify({
        "universal": _UNIVERSAL_SOLUTIONS,
        "sector": _SECTOR_SOLUTIONS
    })
